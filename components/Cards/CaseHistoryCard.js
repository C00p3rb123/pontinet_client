  ...
  return (
    <TouchableWithoutFeedback onPress={() => setExpanded(!expanded)}>
      ...
      >
        ...
        <Text style={[styles.description, { paddingTop: 5 }]}>
          {caseDetails.patientInformation.age} |{" "}
        ...
        {expanded && (
          <View style={styles.expanded}>
            ...
            >
              <Text>
                {translation.screens.authScreens.caseHistory.adviceGiven}
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.button}
              onPress={() =>
                Alert.alert(
                  translation.screens.authScreens.caseHistory
                    .incorrectPermissions,
                  translation.screens.authScreens.caseHistory.contact,
                  [],
                  { cancelable: true }
                )
              }
            >
              <Text>
                {translation.screens.authScreens.caseHistory.reopenCase}
              </Text>
            </TouchableOpacity>
          </View>
        )}
